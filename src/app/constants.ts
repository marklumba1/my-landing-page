...
export const realtimeUpdates = {
  ...
  features: [
    ...
    },
    {
      ...
      icon: { component: BarChart2, className: "w-6 h-6" },
    },
  ],
};
...
export const growthLevels = {
  ...
  features: [
    ...
    },
    {
      ...
      icon: { component: BookOpen, className: "w-6 h-6" }
    },
    {
      ...
      icon: { component: Activity, className: "w-6 h-6" }
    },
    {
