...
export default function Announcement({ label, text, link }: AnnouncementProps) {
  return (
    <a
      href={link}
      className="border text-sm relative flex items-center gap-2 group overflow-hidden  rounded-full pr-2"
    >
      ...
      <div className="relative overflow-hidden">
        <ArrowRight size={20} className="absolute group-hover:translate-x-5" />
        <ArrowRight size={20} className="absolute  group-hover:translate-x-0 -translate-x-5" />
