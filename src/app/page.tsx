    ...
    <div className="flex flex-col gap-20 py-20">
      ...
      <section className="max-w-7xl mx-auto">
        <Highlight
          ...
          title={
            <p>
              Everything you need, all in <TextHighlight text="one place" />
            </p>
          }
          cta={{ label: "Get a demo", type: "secondary", icon: <Book /> }}
        />
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 px-10">
          {cards.map((card) => (
        ...
        <Background>
          <div className="max-w-7xl mx-auto">
            <Highlight
              title={
                <p>
                  Less paperwork more <TextHighlight text="people work." />
                </p>
              }
      ...
      <section className="max-w-7xl mx-auto">
        <Background>
          <Highlight
            title={
              <p>
                Make <TextHighlight text="actionable" /> decisions simpler.
              </p>
            }
